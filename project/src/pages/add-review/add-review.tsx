...
import { getFilm, getFilmStatus } from '../../store/current-film/selectors';
...
function AddReview(): JSX.Element {
  ...
  const isFilmLoaded = useAppSelector(getFilmStatus);
  ...
  useEffect(() => {
    ...
    if ( !isFilmLoaded || (film && !(film.id === id)) ) {
      ...
      {film &&
        <>
          ...
          <div className="add-review">
            {isFilmLoaded ? <FormReview filmId={film.id} rating={film.rating} /> : <Spiner />}
          </div>
        </>}
    </section>
  );
